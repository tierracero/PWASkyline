//
//  API+GetFiscalAutotrasportTypes.swift
//  
//
...
func getFiscalAutotrasportTypes(
    /// Term to Search
    term: String,
    ...
    let url = baseAPIUrl( "https://api.tierracero.co/v1/getFiscalAutotrasportTypes") + "&term=\(_term)"
