//
//  API+GetFiscalDangerousMaterials.swift
//  
//
...
func getFiscalDangerousMaterials(
    /// Term to Search
    term: String,
    ...
    let url = baseAPIUrl( "https://api.tierracero.co/v1/getFiscalDangerousMaterials") + "&term=\(_term)"
