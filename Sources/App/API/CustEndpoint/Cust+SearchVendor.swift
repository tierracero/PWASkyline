...
func searchVendor(
    /// Term to Search
    term: String,
    callback: @escaping ((_ term: String, _ resp: [CustVendorsQuick])->())
){
    ...
    let url = baseAPIUrl("https://api.tierracero.co/cust/v1/searchVendor") + "&term=\(_term)"
