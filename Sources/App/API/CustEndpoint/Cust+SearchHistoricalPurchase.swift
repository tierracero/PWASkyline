//
//  Cust+SearchHistoricalPurchase.swift
//  
//
...
func searchHistoricalPurchase(
    /// Term to Search
    term: String,
    callback: @escaping ((_ term: String, _ resp: [SearchHistoricalPurchaseResponse])->())
){
    ...
    let url = baseAPIUrl("https://api.tierracero.co/cust/v1/searchHistoricalPurchase") + "&term=\(_term)"
