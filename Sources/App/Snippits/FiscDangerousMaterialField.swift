//
//  FiscDangerousMaterialField.swift
//  
//
...
class FiscDangerousMaterialField: Div {
    ...
    lazy var fiscCodeField: InputText = InputText(self.$fiscCodeDescription)
        //.readonly(true)
        .placeholder("ACIDO FLUOROACETICO, ACIDO FOSFOROSO...")
    ...
    */
    ...
    func loadFiscalCodeData(_ code: String){
        ...
        if !self.currentCode.isEmpty {
            ...
            API.v1.getFiscalDangerousMaterial (code: self.currentCode) { resp in
    ...
    func searcCode(){
        ...
        Dispatch.asyncAfter(0.37) {
            ...
            */
            ...
            getFiscalDangerousMaterials(term: term) { term, resp in
