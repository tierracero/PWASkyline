...
class AddCartaPorteFromHistoryView: Div {
    ...
    let cartaPortes: [CustFiscalCartaPorteItem]
    ...
    init(
        cartaPortes: [CustFiscalCartaPorteItem],
        callback: @escaping ((
            _ cartaPorte: CustFiscalCartaPorteItem
        ) -> ())
    ) {
    ...
    var selectedCartaPorte: CustFiscalCartaPorteItem? = nil
    ...
    func selectCartaPorte(cartaPorte: CustFiscalCartaPorteItem) {
