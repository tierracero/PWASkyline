...
class ManagePOC: Div {
    ...
    override func didRemoveFromDOM() {
        ...
        $totalInventoryCount.removeAllListeners()
        $currentView.removeAllListeners()
        $currentThirdPartyStore.removeAllListeners()
        $selectBrandViewIsHidden.removeAllListeners()
        $selectedBrand.removeAllListeners()
        $brandCount.removeAllListeners()
        ...
        $pricecr.removeAllListeners()
        $inCredit.removeAllListeners()
        $downPay.removeAllListeners()
        $monthToPay.removeAllListeners()
        $breakType.removeAllListeners()
        $breakOne.removeAllListeners()
        $breakOneText.removeAllListeners()
        $breakTwo.removeAllListeners()
        $breakTwoText.removeAllListeners()
        $breakThree.removeAllListeners()
        $breakThreeText.removeAllListeners()
        $minInventory.removeAllListeners()
        $promo.removeAllListeners()
        $providers.removeAllListeners()
        $appliedTo.removeAllListeners()
        $files.removeAllListeners()
        $comision.removeAllListeners()
        $points.removeAllListeners()
        $premier.removeAllListeners()
        $codes.removeAllListeners()
        $warentySelf.removeAllListeners()
        $warentyProvider.removeAllListeners()
        $highlight.removeAllListeners()
        $reqSeries.removeAllListeners()
        $maximize.removeAllListeners()
        $level.removeAllListeners()
        $series.removeAllListeners()
        $status.removeAllListeners()
        $conditions.removeAllListeners()
        ...
        $pricecrTaxText.removeAllListeners()
        $pricecrDownPayText.removeAllListeners()
        $pricecrMothsText.removeAllListeners()
        $noteText.removeAllListeners()
        $taxes.removeAllListeners()
        $selectedInventoryView.removeAllListeners()
        $bodegaSelectObserver.removeAllListeners()
        $currentNewInventory.removeAllListeners()
        $misplacedInventory.removeAllListeners()
    }
}
