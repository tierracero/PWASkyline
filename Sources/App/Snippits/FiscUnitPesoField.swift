...
class FiscUnitPesoField: Div {
    ...
    lazy var fiscUnitField: InputText = InputText(self.$fiscUnitDescription)
        //.readonly(true)
        .placeholder("Lote, Caja de carton, Viga...")
    ...
    */
    func loadFiscalCodeData(_ code: String){
        ...
        if !self.currentCode.isEmpty {
            ...
            API.v1.getFiscalPesoUnit(code: self.currentCode) { resp in
...
//                }
            ...
            */
            ...
            getFiscalUnitPesos(term: term) { term, resp in
