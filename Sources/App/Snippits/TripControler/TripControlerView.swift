...
class TripControlerView: Div {
    ...
    @DOM override var body: DOM.Content {
        ...
        Div {
            ...
            Div(self.$cartaPorte.map{ state in

                switch self.mode {
                    case .cartaPorte:
                    return ((state == nil) ? "Agregar Carta Porte" : "Guardar Carta Porte")
                    case .trip:
                    return ((state == nil) ? "Agregar Viaje" : "Guardar Viaje")
                }
    ...
    func addCartaPorte(){
        ...
        var remolques: [FiscalRemolqueItem] = []
        ...
        if let _tipoRemolqueA = TipoRemolque(rawValue: tipoRemolqueA) {
            ...
            remolques.append(FiscalRemolqueItem(
                id: .init(),
                type: _tipoRemolqueA,
