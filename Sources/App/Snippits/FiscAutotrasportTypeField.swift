//
//  FiscAutotrasportTypeField.swift
//  
//
...
class FiscAutotrasportTypeField: Div {
    ...
    lazy var fiscUnitField: InputText = InputText(self.$fiscUnitDescription)
        .placeholder("Grúa de Pluma Tipo A, Grúa de Pluma Tipo B...")
    ...
    */
    ...
    func loadFiscalCodeData(_ code: String){
        ...
        if !self.currentCode.isEmpty {
            ...
            API.v1.getFiscalAutotrasportType(code: self.currentCode) { resp in
    ...
    func searcCode(){
        ...
        Dispatch.asyncAfter(0.37) {
            ...
            */
            ...
            getFiscalAutotrasportTypes(term: term) { term, resp in
