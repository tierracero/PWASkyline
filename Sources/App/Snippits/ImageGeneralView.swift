...
class ImageGeneralView: Div {
        ...
        Div{
            ...
            Div{
                ...
                self.imageAvatar
                    ...
                    /*
                    TODO: analize if we should  apply o compleatly remove 
                Img()
    ...
    override func buildUI() {
        ...
        self.path = relation.url(
            url: custCatchUrl,
            pDir: pDir,
            isPreRegistration: relationId == nil ? true : false,
            accountType: custCatchAccountType
        )
    ...
    func setAvatar() {
        ...
        switch relation {
        case .asset:
            relationType = .asset(mediaId)
        case .assetItem:
            relationType = .assetItem(mediaId)
        default:
