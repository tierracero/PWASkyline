...
/*
    ...
    override func didRemoveFromDOM() {
        ...
        $verifyDropDownIsHidden.removeAllListeners()
        $lockPrices.removeAllListeners()
        $substractedTaxCalculation.removeAllListeners()
        $subTotal.removeAllListeners()
        $discount.removeAllListeners()
        $trasTotal.removeAllListeners()
        $retTotal.removeAllListeners()
        $total.removeAllListeners()
        $items.removeAllListeners()
        $itemViews.removeAllListeners()
        $selectFiscalProfileIsHidden.removeAllListeners()
        $selectPackage.removeAllListeners()
        $profiles.removeAllListeners()
        $profile.removeAllListeners()
        $reciver.removeAllListeners()
        $reciverRazon.removeAllListeners()
        $reciverRfc.removeAllListeners()
        $reciverZip.removeAllListeners()
        $reciverRegimen.removeAllListeners()
        $communicationMethod.removeAllListeners()
        $reciverRazonIsDisabled.removeAllListeners()
        $reciverRfcIsDisabled.removeAllListeners()
        $reciverZipIsHidden.removeAllListeners()
        $reciverRegimenIsHidden.removeAllListeners()
        $currentView.removeAllListeners()
        $hiringMode.removeAllListeners()
        ...
        $methodForm.removeAllListeners()
        $methodFormListener.removeAllListeners()
        $useOfDocument.removeAllListeners()
        $useOfDocumentListener.removeAllListeners()
        $documentFilter.removeAllListeners()
        $fiscalProfileListener.removeAllListeners()
        $periodSelectListener.removeAllListeners()
        $monthSelectListener.removeAllListeners()
        $yearFieldListener.removeAllListeners()
    }
}
