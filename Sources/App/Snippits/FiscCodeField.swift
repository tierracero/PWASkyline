...
class FiscCodeField: Div {
    ...
    lazy var fiscCodeField: InputText = InputText(self.$fiscCodeDescription)
        .placeholder("Piano, Aciete, Tarifa de mano de obra...")
    ...
    func loadFiscalCodeData(_ code: String){
        ...
        if !self.currentCode.isEmpty {
            ...
            API.v1.getFiscalCode(code: self.currentCode) { resp in
    ...
    func searcCode(){
        ...
        Dispatch.asyncAfter(0.37) {
            ...
            getFiscalCodes(term: term) { term, resp in
