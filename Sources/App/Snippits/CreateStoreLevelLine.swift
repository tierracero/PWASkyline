...
class CreateStoreLevelLine: Div {
    ...
    var titleText = "Crear Linea"
    
    var buttonText = "Crear Linea"
    ...
    @DOM override var body: DOM.Content {
        ...
        Div{
            ...
            H3("Crear linea en \( self.catname.uppercased() )")
                .class(.oneLineText)
                .color(.darkOrange)
    ...
    func deleteLevel(){
        ...
        addToDom(ConfirmView(
            ...
            message: "¿Realmente desea eliminar linea \(line.name)?"){ isConfirmed, message in
