...
extension ToolsView.WebPage {
    ...
    class IndexPage: Div {
        ...
        override func didRemoveFromDOM() {
            ...
            $carouselOneText.removeAllListeners()
            $carouselOneSecondaryText.removeAllListeners()
            $carouselOneBtnIsActive.removeAllListeners()
            $carouselOneBtnText.removeAllListeners()
            $carouselOneBtnLink.removeAllListeners()
            $carouselTwoText.removeAllListeners()
            $carouselTwoSecondaryText.removeAllListeners()
            $carouselTwoBtnIsActive.removeAllListeners()
            $carouselTwoBtnText.removeAllListeners()
            $carouselTwoBtnLink.removeAllListeners()
            $carouselThreeText.removeAllListeners()
            $carouselThreeSecondaryText.removeAllListeners()
            $carouselThreeBtnIsActive.removeAllListeners()
            $carouselThreeBtnText.removeAllListeners()
            $carouselThreeBtnLink.removeAllListeners()
            $imgOne.removeAllListeners()
            $imgTwo.removeAllListeners()
            $imgThree.removeAllListeners()
            $imgFour.removeAllListeners()
            $imgFive.removeAllListeners()
            $imgSix.removeAllListeners()
            $imgSeven.removeAllListeners()
            $imgEight.removeAllListeners()
            $imgNine.removeAllListeners()
            $imgTen.removeAllListeners()
            $imgEleven.removeAllListeners()
            $imgTwelve.removeAllListeners()
            $carouselOneForeground.removeAllListeners()
            $carouselOneBackground.removeAllListeners()
            $carouselTwoForeground.removeAllListeners()
            $carouselTwoBackground.removeAllListeners()
            $carouselThreeForeground.removeAllListeners()
            $carouselThreeBackground.removeAllListeners()
            $imagesOne.removeAllListeners()
            $imagesTwo.removeAllListeners()
            $imagesThree.removeAllListeners()
            $imagesFour.removeAllListeners()
            $imagesFive.removeAllListeners()
            $imagesSix.removeAllListeners()
            $imagesSeven.removeAllListeners()
            $imagesEight.removeAllListeners()
            $imagesNine.removeAllListeners()
            $imagesTen.removeAllListeners()
            $imagesEleven.removeAllListeners()
            $imagesTwelve.removeAllListeners()
            $carucelOneForground.removeAllListeners()
            $carucelOneBackground.removeAllListeners()
            $carucelTwoForground.removeAllListeners()
            $carucelTwoBackground.removeAllListeners()
            $carucelThreeForground.removeAllListeners()
            $carucelThreeBackground.removeAllListeners()
        }
    }
}
