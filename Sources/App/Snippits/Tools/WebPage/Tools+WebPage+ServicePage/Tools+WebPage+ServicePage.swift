//
//  Tools+WebPage+Service.swift
//
//
//  Created by Victor Cantu on 1/23/25.
//
...
extension ToolsView.WebPage {
    ...
    class ServicePage: Div {
        ...
        @State var services: [CustWebContent]
        ...
        lazy var serviceRowsGrid = Div()
            .custom("height", "calc(100% - 37px)")
            .overflow(.auto)
        
        /// [CustWebContent.Id : ServiceRow ]
        var serviceRows: [UUID : ServiceRow] = [:]
                                ...
                                Img()
                                    ...
                                    .onClick {
                                        ...
                                        let view = ServiceView(
                                            ...
                                            files: [],
                                            notes: []
                                        ) { serviceId, name, description in
                                            
                                            guard let view = self.serviceRows[serviceId] else {
                                                return
                                            }
                                        ...
                                        } deleteService: { serviceId in
                                            
                                            self.serviceRows[serviceId]?.remove()
                                            
                                            self.serviceRows.removeValue(forKey: serviceId)
        ...
        func addServiceRow(_ service: CustWebContent) {
            ...
            serviceRows[service.id] =  view
            
            serviceRowsGrid.appendChild(view)
