...
extension ToolsView.SystemSettings {
    ...
    class SeviceOrder: Div {
        ...
        override func didRemoveFromDOM() {
            ...
            $moduleProfileOrder.removeAllListeners()
            $moduleProfileRental.removeAllListeners()
            $moduleProfileDate.removeAllListeners()
            $gridView.removeAllListeners()
            $accountMobileConfirmationMode.removeAllListeners()
            $accountIdConfirmationMode.removeAllListeners()
            $orderMobileConfirmationMode.removeAllListeners()
            $rentalMobileConfirmationMode.removeAllListeners()
            $dateMobileConfirmationMode.removeAllListeners()
            $orderIdConfirmationMode.removeAllListeners()
            $rentalIdConfirmationMode.removeAllListeners()
            $dateIdConfirmationMode.removeAllListeners()
            $createPersonalAccountMode.removeAllListeners()
            $createBuisnessAccountMode.removeAllListeners()
            $currency.removeAllListeners()
            $restrictOrderCreation.removeAllListeners()
            $restrictOrderClosing.removeAllListeners()
            $restrictOrderCharges.removeAllListeners()
            $restrictSaleCharges.removeAllListeners()
            $restrictMermProduct.removeAllListeners()
            $restrictDeleteCharges.removeAllListeners()
            $restrictDeletePayments.removeAllListeners()
            $restrictDeleteFiscal.removeAllListeners()
            $autoDeleteCTAM.removeAllListeners()
            $openFiscalInvoce.removeAllListeners()
            $generalComision.removeAllListeners()
            $viewPricesOnWeb.removeAllListeners()
            $varialPricesDisclosure.removeAllListeners()
            $lastServicePriceRangeID.removeAllListeners()
            $servicePriceRange.removeAllListeners()
            $lastProductPriceRangeID.removeAllListeners()
            $productPriceRange.removeAllListeners()
            $orderDateReminderMorning.removeAllListeners()
            $orderDateReminderConcurring.removeAllListeners()
            $orderPendingPickupLimitAlert.removeAllListeners()
            $orderPendingPickupLimitStart.removeAllListeners()
            $orderPendingPickupLimitEnd.removeAllListeners()
            $orderPendingPickupLimitEveryWhen.removeAllListeners()
            $orderPendingPickupLimitEveryWhenMsg.removeAllListeners()
            $orderPendingPickupLimitThreeDayAlertMsg.removeAllListeners()
            $orderPendingPickupLimitOneDayAlertMsg.removeAllListeners()
            $orderPendingPickupLimitZeroDayAlertMsg.removeAllListeners()
            $orderContract.removeAllListeners()
            $orderAddedProductDelivery.removeAllListeners()
            $saleProductDelivery.removeAllListeners()
            $creditType.removeAllListeners()
            $billingDate.removeAllListeners()
            $creditDays.removeAllListeners()
            $initialCreditLimit.removeAllListeners()
            $creditRequisitObject.removeAllListeners()
            $rewardsStructureTypeHelper.removeAllListeners()
            $rewardsStructureType.removeAllListeners()
            $rewardsTierClubBreak.removeAllListeners()
            $rewardsTierBronceBreak.removeAllListeners()
            $rewardsTierSilverBreak.removeAllListeners()
            $rewardsTierGoldBreak.removeAllListeners()
            $rewardsTierDiamondBreak.removeAllListeners()
            $rewardsPercentProductTierClub.removeAllListeners()
            $rewardsPercentProductTierBronce.removeAllListeners()
            $rewardsPercentProductTierSilver.removeAllListeners()
            $rewardsPercentProductTierGold.removeAllListeners()
            $rewardsPercentProductTierDiamond.removeAllListeners()
            $rewardsPercentServiceTierClub.removeAllListeners()
            $rewardsPercentServiceTierBronce.removeAllListeners()
            $rewardsPercentServiceTierSilver.removeAllListeners()
            $rewardsPercentServiceTierGold.removeAllListeners()
            $rewardsPercentServiceTierDiamond.removeAllListeners()
            $rewardsRefrenceTierOne.removeAllListeners()
            $rewardsRefrenceTierTwo.removeAllListeners()
            $rewardsRefrenceTierThree.removeAllListeners()
            $welcomeGift.removeAllListeners()
            $rewardsTierClubItems.removeAllListeners()
            $rewardsTierBronceItems.removeAllListeners()
            $rewardsTierSilverItems.removeAllListeners()
            $rewardsTierGoldItems.removeAllListeners()
            $rewardsTierDiamondItems.removeAllListeners()
            $orderOpenInscriptionMode.removeAllListeners()
            $orderCloseInscriptionMode.removeAllListeners()
            $pointOfSaleCloseInscriptionMode.removeAllListeners()
            $newAccountCloseInscriptionMode.removeAllListeners()
            $orderSerialization.removeAllListeners()
            $saleSerialization.removeAllListeners()
            $fiscalSerialization.removeAllListeners()
            $requireInstituteTag.removeAllListeners()
            $instituteTag.removeAllListeners()
            $customerType.removeAllListeners()
            $requierServiceAddress.removeAllListeners()
            $requierMailingAddrees.removeAllListeners()
            $requirePhysicalAddress.removeAllListeners()
            $operationalContact.removeAllListeners()
            $salesContact.removeAllListeners()
            $finacialContact.removeAllListeners()
            $sendNewBusinessAccountComunication.removeAllListeners()
        }
    }
}
