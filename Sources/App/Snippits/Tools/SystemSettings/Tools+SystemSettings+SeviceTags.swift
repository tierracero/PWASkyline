...
extension ToolsView.SystemSettings {
    ...
    class SeviceTags: Div {
        ...
        override func didRemoveFromDOM() {
            ...
            $typeOfServiceObject.removeAllListeners()
            $idTagName.removeAllListeners()
            $idTagDescr.removeAllListeners()
            $idTagPlaceholder.removeAllListeners()
            $secondIDTagRequiered.removeAllListeners()
            $secondIDTagName.removeAllListeners()
            $secondIDTagDescr.removeAllListeners()
            $secondIDTagPlaceholder.removeAllListeners()
            $useBrandModelMode.removeAllListeners()
            $tag1.removeAllListeners()
            $tag1Name.removeAllListeners()
            $tag1Placeholder.removeAllListeners()
            $tag2.removeAllListeners()
            $tag2Name.removeAllListeners()
            $tag2Placeholder.removeAllListeners()
            $tag3.removeAllListeners()
            $tag3Name.removeAllListeners()
            $tag3Placeholder.removeAllListeners()
            $tag4.removeAllListeners()
            $tag4Name.removeAllListeners()
            $tag4Placeholder.removeAllListeners()
            $tag5.removeAllListeners()
            $tag5Name.removeAllListeners()
            $tag5Placeholder.removeAllListeners()
            $tag6.removeAllListeners()
            $tag6Name.removeAllListeners()
            $tag6Placeholder.removeAllListeners()
            $checkTag1.removeAllListeners()
            $checkTag1Name.removeAllListeners()
            $checkTag2.removeAllListeners()
            $checkTag2Name.removeAllListeners()
            $checkTag3.removeAllListeners()
            $checkTag3Name.removeAllListeners()
            $checkTag4.removeAllListeners()
            $checkTag4Name.removeAllListeners()
            $checkTag5.removeAllListeners()
            ...
            $serviceMap.removeAllListeners()
            $sideStatus.removeAllListeners()
            $diagnosticResolutionActions.removeAllListeners()
        }
    }
}
