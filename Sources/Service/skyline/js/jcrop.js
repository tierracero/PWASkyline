...
, function(e, t, n) {
    ...
    var i = function() {
        ...
        return r(e, [{
            ...
            key: "addClass",
            value: function(e) {
                return this.hasClass(e) || (this.el.className += " " + e),
                this
            }
        }, {
            key: "listen",
...
, function(e, t, n) {
    ...
    var i = function() {
        ...
        return r(e, [{
            ...
            value: function(t, n) {
                return n = n || t,
                e.create(this.x, this.y, this.w * t, this.h * n)
            }
        }, {
            key: "center",
            value: function(t, n) {
    ...
    i.fromArray = function(e) {
        if (4 === e.length)
            return i.create.apply(this, e);
        if (2 === e.length)
            return i.fromPoints(e[0], e[1]);
        throw "fromArray method problem"
    }
    ,
    i.sizeOf = function(e, t) {
        if (t)
            return i.create(0, 0, e, t);
        var n = new i;
        return n.w = e.offsetWidth,
        n.h = e.offsetHeight,
        n
    }
    ,
...
, function(e, t, n) {
    ...
    var a = function() {
        function e(t, n, r, i) {
            ...
            this.sh = r,
            this.rect = t,
            this.locked = this.getCornerPoint(this.getOppositeCorner(i)),
            this.stuck = this.getCornerPoint(i)
        }
        return i(e, [{
            key: "move",
            value: function(e, t) {
    ...
    var l = function(e) {
        ...
        r(t, [{
            ...
            value: function() {
                ...
                return this[e ? "removeClass" : "addClass"](t),
                this.enabled = !!e,
                this
            }
        }, {
            key: "focus",
            value: function() {
                return !!this.enabled && (this.active ? this.active.el.focus() : this.el.focus(),
                this)
            }
        }, {
            key: "limitWidgets",
            value: function() {
                ...
                if (!this.crops || e < 1)
                    return !1;
                for (var t = Array.from(this.crops); t.length > e; )
                    this.removeWidget(t.shift());
                return this
            }
        }, {
            key: "canCreate",
            ...
            value: function() {
                ...
                this.crops.forEach(function(n) {
                    n.el.style.zIndex = t++,
                    e.active === n ? n.addClass("active") : n.removeClass("active")
                }),
                this.refresh()
            }
        }, {
            ...
            value: function() {
                ...
                )(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "setOptions", this).call(this, e),
                this.crops && Array.from(this.crops).forEach(function(t) {
...
, function(e, t, n) {
    ...
    var v = function(e) {
        function t(e) {
            ...
            return r.pos = c.default.from(r.el),
            r.init(),
            r
        }
        return function(e, t) {
    ...
    v.create = function() {
        ...
        this.imgName = n.cropperId
        
        
        return t.setAttribute("tabindex", "0"),
        t.className = n.cropperClass || "jcrop-widget",
        t.id = n.cropperId || "",
        new (e.widgetConstructor || v)(t,n)
    }
    ,
    t.default = v
}
...
, function(e, t, n) {
    ...
    var s = function(e) {
        function t(e) {
            ...
            return r.options = {},
            Object.defineProperty(r, "_optconf", {
                configurable: !1,
                enumerable: !1,
                value: {},
                writable: !0
...
, function(e, t, n) {
    ...
    var s = function() {
        ...
        return r(e, [{
            ...
            value: function() {
                ...
                this.active = void 0 === t.shade || t.shade,
            ...
            value: function(e) {
                ...
                n.t.h = e.y,
                n.b.h = t.h - e.y2,
                n.t.w = n.b.w = Math.floor(e.w),
                n.l.w = n.t.x = n.b.x = Math.ceil(e.x),
                n.r.w = t.w - (Math.ceil(e.x) + Math.floor(e.w))
            }
        }, {
            key: "keys",
            value: function() {
    ...
    s.attach = function(e) {
        var t = e.el,
        n = new s(t);
        return n.init(e.options),
        e.shades = n,
        e._optconf.shade = function(t) {
    ...
    c.create = function(e, t) {
        ...
        return n.className = r + " " + t,
        new c(n).color(e.shadeColor).opacity(e.shadeOpacity)
    }
    ,
    c.Manager = s,
    t.default = c
...
, function(e, t, n) {
    ...
    t.DomObj = t.Shade = t.load = t.easing = t.Sticker = t.Handle = t.Rect = t.Widget = t.Dragger = t.defaults = t.Stage = void 0,
    t.attach = b;
    var r = y(n(0))
      , i = y(n(3))
      , o = y(n(6))
    ...
    function b(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
        return t = (0,
        r.default)({}, i.default, t),
        "string" == typeof e && (e = document.getElementById(e)),
        "IMG" === e.tagName ? new a.default(e,t) : new o.default(e,t)
    }
    t.Stage = o.default,
